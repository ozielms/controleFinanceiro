function cadContas(cartao, descricao, valorCompra, dataEntrada, numParcelas) {
  ...
  switch(mes) {
    case 'janeiro': mesTabela = "gastosJan"; mesTotal = "#celTotalJan"; contMes = 1; break;
    case 'fevereiro': mesTabela = "gastosFev"; mesTotal = "#celTotalFev"; contMes = 2; break;
    case 'março': mesTabela = "gastosMar"; mesTotal = "#celTotalMar"; contMes = 3; break;
    case 'abril': mesTabela = "gastosAbr"; mesTotal = "#celTotalAbr"; contMes = 4; break;
    case 'maio': mesTabela = "gastosMai"; mesTotal = "#celTotalMai"; contMes = 5; break;
    case 'junho': mesTabela = "gastosJun"; mesTotal = "#celTotalJun"; contMes = 6; break;
    case 'julho': mesTabela = "gastosJul"; mesTotal = "#celTotalJul"; contMes = 7; break;
    case 'agosto': mesTabela = "gastosAgo"; mesTotal = "#celTotalAgo"; contMes = 8; break;
    case 'setembro': mesTabela = "gastosSet"; mesTotal = "#celTotalSet"; contMes = 9; break;
    case 'outubro': mesTabela = "gastosOut"; mesTotal = "#celTotalOut"; contMes = 10; break;
    case 'novembro': mesTabela = "gastosNov"; mesTotal = "#celTotalNov"; contMes = 11; break;
    case 'dezembro': mesTabela = "gastosDez"; mesTotal = "#celTotalDez"; contMes = 12; break;
    default: alert("Mês inválido"); break;
  }

  // FUNÇÃO INSERIR DADOS NA TABELA -------------------------------

  var inserirConteudoCell = function (qtdLinhas, nomeCartao, descricaoCartao, valorDaCompra, dia, numeroDeParcelas, mesTabela, contMes) {
...
while (cont < numeroDeParcelas) {
      ...
      switch(contMes) {
        case 1: mesTabela = "gastosJan"; mesTotal = "#celTotalJan"; break;
        case 2: mesTabela = "gastosFev"; mesTotal = "#celTotalFev"; break;
        case 3: mesTabela = "gastosMar"; mesTotal = "#celTotalMar"; break;
        case 4: mesTabela = "gastosAbr"; mesTotal = "#celTotalAbr"; break;
        case 5: mesTabela = "gastosMai"; mesTotal = "#celTotalMai"; break;
        case 6: mesTabela = "gastosJun"; mesTotal = "#celTotalJun"; break;
        case 7: mesTabela = "gastosJul"; mesTotal = "#celTotalJul"; break;
        case 8: mesTabela = "gastosAgo"; mesTotal = "#celTotalAgo"; break;
        case 9: mesTabela = "gastosSet"; mesTotal = "#celTotalSet"; break;
        case 10: mesTabela = "gastosOut"; mesTotal = "#celTotalOut"; break;
        case 11: mesTabela = "gastosNov"; mesTotal = "#celTotalNov"; break;
        case 12: mesTabela = "gastosDez"; mesTotal = "#celTotalDez"; break;
      }

      if (contMes > 12) {
        alert("A(s) próxima(s) " + (numeroDeParcelas-cont) + " parcela(s) ficará(ão) para o próximo ano!");
        break;
      }
